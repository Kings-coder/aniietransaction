import 'package:bloctutorial/src/core/utils/extensions/text.dart';
import 'package:bloctutorial/src/core/utils/extensions/time.dart';
...
class TextStyles {
  static TextStyle proxima = const TextStyle(fontFamily: 'proxima');
  // static TextStyle quicksand = GoogleFonts.montserrat();

  static TextStyle get t1 => proxima.regular.size(FontSizes.s16);

  static TextStyle get t2 => proxima.semiBold.size(FontSizes.s14);

  static TextStyle get h1 => proxima.bold.size(FontSizes.s96);

  static TextStyle get h2 => proxima.bold.size(FontSizes.s60);

  static TextStyle get h3 => proxima.bold.size(FontSizes.s48);

  static TextStyle get h4 => proxima.bold.size(FontSizes.s34);

  static TextStyle get h5 => proxima.bold.size(FontSizes.s24);

  static TextStyle get h6 => proxima.semiBold.size(FontSizes.s20);

  static TextStyle get h7 => proxima.semiBold.size(FontSizes.s18);

  static TextStyle get body1 => proxima.regular.size(FontSizes.s16);

  static TextStyle get body2 => proxima.regular.size(FontSizes.s14);

  static TextStyle get body3 => proxima.size(FontSizes.s12);

  static TextStyle get footnote => proxima.regular.size(FontSizes.s10);

  static TextStyle get caption => proxima.regular.size(FontSizes.s12);

  static TextStyle get button => proxima.light.size(FontSizes.s16);
}
